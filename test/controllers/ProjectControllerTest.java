...
//        PlayList project = PlayList.find.where()
...
//
//        assertEquals(200, status(result));
//        assertEquals(newName, PlayList.find.byId(id).name);
//    }
//
//    @Test
...
//        assertEquals("Private", PlayList.find.byId(id).name);
//    }
